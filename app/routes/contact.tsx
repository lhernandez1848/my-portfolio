...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Lisdanay Hernandez - Contact" },
    ...
    <section className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <form action="#" className="space-y-8">
          ...
          <button type="submit" className="bg-cyan-800 hover:bg-cyan-950 text-white font-bold py-2 px-4 rounded-full">Send message</button>
        </form>
      </div>
    </section>
  )

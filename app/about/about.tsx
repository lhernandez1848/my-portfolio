...
const resources = [
  ...
  },
  {
    ...
    handle: "",
    icon: (
      <svg className="h-6 fill-current text-gray-600 hover:text-cyan-800" version="1.1" viewBox="0 0 382 382">

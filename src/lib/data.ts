export const COLOR_MODE = ["PINK","TEAL","GREEN","BLUE"];
...
export const ABOUT = {
  ...
  initials: "LH",
  greeting: "Hello",
  subgreeting: "Get to know me & what I do",
...
export const EXPERIENCE = [
  {
    ...
    listHeader: 'As the only Front-End developer for this Fintech startup, I was responsible for the initial design and implementation of the main platform; Insights. Reporting to the CTO, the software team consisted of three back-end developers and myself. Ongoing responsibilities included:',
    list: [
      'Participated in an agile environment with daily scrum meetings in order to introduce new features, and meet project requirements',
      ...
      'Collaborated closely with/lead designers and product team to execute and launch company website using WebFlow'
    ]
  },
  {
    name: 'UX/UI DESIGNER',

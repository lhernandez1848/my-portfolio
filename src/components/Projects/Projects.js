...
export default function Projects() {
  return <Layout id='projects'>
    ...
    <ProjectContainer image={insights.src} title={'Insights'} stack={['React', 'Redux', 'Auth0']}
    ...
    <ProjectContainer image={insights.src} title={'Chatbot Widget'} stack={['React', 'Webflow', 'AWS']}
      description={[
    ...
    <ProjectContainer image={avaanz.src} title={'Avaanz Website'} stack={['Squarespace', 'Javascript']}
      description={[
